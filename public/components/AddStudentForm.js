...
/*		Process similar to fetchSchools Above....

		dispatch(actions.asyncFetchFormFieldValues("Grade"));
		dispatch(actions.asyncFetchFormFieldValues("Gender"));
		dispatch(actions.asyncFetchFormFieldValues("Referral Source"));
		dispatch(actions.asyncFetchFormFieldValues("Ethnicity"));
		dispatch(actions.asyncFetchFormFieldValues("Presenting Issue"));*/
	},
	...
	addStudent(e){
		...
		if (this.ensureInputEntered() && this.validateInput()){
			this.props.onAddStudent({
				...
				lunchOption: this.refs.lunchOption.value,
				presentingIssue: this.refs.presentingIssue.value,
			...
			<div class="well">
				...
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select class="form-control" ref="referral">
								<option>Self</option>
								<option>Peer</option>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select class="form-control" ref="presentingIssue">
					...
					<div class="form-group">
						...
						<div class="checkbox col-sm-5">
							<label>
								<input type="checkbox" ref="lunchOption"/>
							</label>
						</div>
					</div>
		          	<div class="form-group">
